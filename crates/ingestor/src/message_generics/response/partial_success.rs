...
pub trait PartialSuccessResponse: SealedResponse {
    ...
    fn partial_success(rejected_count: u32, reason: Option<String>) -> Self;
}
        ...
        fn partial_success(rejected_count: u32, reason: Option<String>) -> Self {
            ExportLogsServiceResponse {
                partial_success: Some(ExportLogsPartialSuccess {
                    rejected_log_records: rejected_count.into(),
        ...
        fn partial_success(rejected_count: u32, reason: Option<String>) -> Self {
            ExportMetricsServiceResponse {
                partial_success: Some(ExportMetricsPartialSuccess {
                    rejected_data_points: rejected_count.into(),
                    error_message: reason.unwrap_or_default(),
                }),
            }
        }
        ...
        fn partial_success(rejected_count: u32, reason: Option<String>) -> Self {
            ExportTraceServiceResponse {
                partial_success: Some(ExportTracePartialSuccess {
                    rejected_spans: rejected_count.into(),
                    error_message: reason.unwrap_or_default(),
                }),
            }
        }
